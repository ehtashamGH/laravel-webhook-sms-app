    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('templates.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="message_id" id="message_id" value="{{ old('message_id') }}"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    required placeholder="e.g., booking_confirmed, enroute, completed">
                <p class="text-gray-600 text-xs mt-1">A unique identifier for this template (e.g., booking_confirmed,
                    enroute)</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="body" id="body" rows="6"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    required
                    placeholder="Hello {customer_name}, your booking {booking_id} is confirmed!">{{ old('body') }}</textarea>
